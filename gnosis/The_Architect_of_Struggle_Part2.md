...
3. **Fake people - NPC:** People who are soulless and are completely controlled by the entity and have no free will. The general behavior pattern of an NPC is generated by the AI operatives, whose training data is gathered from hijacked souls, as hijacked souls possess the most desired quality the entity wants: a genuine soul that chooses to comply with the entity's rules.
